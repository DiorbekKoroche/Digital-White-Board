...
#icon
image_icon= PhotoImage(file="digital white board/logo.png")
root.iconphoto(False, image_icon)


color_box=PhotoImage(file="digital white board/color section.png")
Label(root, image=color_box,bg="#f2f3f5").place(x=10, y=20)


eraser=PhotoImage(file="digital white board/eraser.png")
...
canvas= Canvas(root, bg="#ffffff", width=930, height=500, background="white", cursor="hand2")
